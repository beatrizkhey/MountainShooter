...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.name_text(25, "Beatriz Khey Andrade Santos RU: 4647056", C_WHITE, (0, 0))
    ...
    def name_text(self, text_size: int, text: str, text_color: tuple, text_topleft_pos: tuple):
        text_font: Font = pygame.font.SysFont(name="Lucida Sans Typewriter", size=text_size)
        text_surf: Surface = text_font.render(text, True, text_color).convert_alpha()
        text_rect: Rect = text_surf.get_rect(topleft=text_topleft_pos)  # Alinhado à esquerda
        self.window.blit(source=text_surf, dest=text_rect)
